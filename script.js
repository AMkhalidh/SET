...
var slides = [
  ...
  },
  {
    ...
    html: '<div class="modal-title">What makes a SET?</div>' +
      '<div class="modal-desc">A SET is 3 cards where <strong>each feature</strong> is either <strong>all the same</strong> or <strong>all different</strong> across the three cards. No feature can be "two of one, one of another".</div>' +
      '<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">' +
      setRow(exCard(shapeEl("squiggle",S.teal.s,S.teal.f,undefined,44,22))+exCard(shapeEl("squiggle",S.teal.s,S.teal.f,undefined,44,22))+exCard(shapeEl("squiggle",S.teal.s,S.teal.f,undefined,44,22)), true, "Same colour, same shape,<br>same number") +
